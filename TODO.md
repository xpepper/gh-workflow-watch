...
- [ ] Autocompletion: Add tab completion for workflow names and flags
- [x] Watch by workflow file path: Allow watching workflows by file path (e.g., `.github/workflows/ci.yml`) instead of just by name
- [x] Interactive workflow picker: When no workflow is specified, show interactive picker for running workflows
